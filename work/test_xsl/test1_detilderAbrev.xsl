...
<xsl:when test="matches(.,'^(\w*)cõmãderẽt$')">
       ...
       <reg><xsl:value-of select="substring-before(.,'cõmãderẽt')"/>commanderent</reg></choice>
           </xsl:when>
           <!--nécessiterait 3 passages des règles sans cette exception-->
<xsl:when test="matches(.,'^(\w*)cõmẽcemẽt(\w*)$')">
              <choice><orig><xsl:value-of select="."/></orig>
       <reg><xsl:value-of select="substring-before(.,'cõmẽcemẽt')"/>commencement<xsl:value-of select="substring-after(.,'cõmẽcemẽt')"/></reg></choice>
           </xsl:when>
           <!--nécessiterait 3 passages des règles sans cette exception-->
...
<xsl:when test="matches(.,'^(\w*)ãm(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ãm')"/>amm<xsl:value-of select="substring-after(.,'ãm')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ãb(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ãb')"/>amb<xsl:value-of select="substring-after(.,'ãb')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ãp(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ãp')"/>amp<xsl:value-of select="substring-after(.,'ãp')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)dãn(\w*)$', 'i')">
              <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ãn')"/>amn<xsl:value-of select="substring-after(.,'ãn')"/></reg>
  </choice>         
           </xsl:when>
<xsl:when test="matches(.,'^(\w*)ãn(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ãn')"/>ann<xsl:value-of select="substring-after(.,'ãn')"/></reg></choice>
            </xsl:when>
            <xsl:when test="matches(.,'^(\w*)ã[^(a|e|i|o|u|é|è|y)](\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ã')"/>an<xsl:value-of select="substring-after(.,'ã')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ã$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ã')"/>an</reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽm(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ẽm')"/>emm<xsl:value-of select="substring-after(.,'ẽm')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽb(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ẽb')"/>emb<xsl:value-of select="substring-after(.,'ẽb')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽp(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ẽp')"/>emp<xsl:value-of select="substring-after(.,'ẽp')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽn(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ẽn')"/>enn<xsl:value-of select="substring-after(.,'ẽn')"/></reg></choice>
            </xsl:when>
            <xsl:when test="matches(.,'^(\w*)ẽ[^(a|e|i|o|é|è|y)](\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ẽ')"/>en<xsl:value-of select="substring-after(.,'ẽ')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽ$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ẽ')"/>en</reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩm(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ĩm')"/>imm<xsl:value-of select="substring-after(.,'ĩm')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩb(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ĩb')"/>imb<xsl:value-of select="substring-after(.,'ĩb')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩp(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ĩp')"/>imp<xsl:value-of select="substring-after(.,'ĩp')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩn(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ĩn')"/>inn<xsl:value-of select="substring-after(.,'ĩn')"/></reg></choice>
            </xsl:when>
            <xsl:when test="matches(.,'^(\w*)ĩ[^(a|e|i|o|u|é|è|y)](\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ĩ')"/>in<xsl:value-of select="substring-after(.,'ĩ')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩ$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ĩ')"/>in</reg></choice>
            </xsl:when>              
<xsl:when test="matches(.,'^(\w*)õm(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'õm')"/>omm<xsl:value-of select="substring-after(.,'õm')"/></reg></choice>
            </xsl:when>      
<xsl:when test="matches(.,'^(\w*)õb(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'õb')"/>omb<xsl:value-of select="substring-after(.,'õb')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)õp(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'õp')"/>omp<xsl:value-of select="substring-after(.,'õp')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)õn(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'õn')"/>onn<xsl:value-of select="substring-after(.,'õn')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)õ[^(é|è)](\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'õ')"/>on<xsl:value-of select="substring-after(.,'õ')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)õ$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'õ')"/>on</reg></choice>
            </xsl:when>            
<xsl:when test="matches(.,'^(\w*)ũm(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ũm')"/>umm<xsl:value-of select="substring-after(.,'ũm')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũb(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ũb')"/>umb<xsl:value-of select="substring-after(.,'ũb')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũp(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ũp')"/>ump<xsl:value-of select="substring-after(.,'ũp')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũn(\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ũn')"/>umn<xsl:value-of select="substring-after(.,'ũn')"/></reg></choice>
            </xsl:when>
            <xsl:when test="matches(.,'^(\w*)ũ[^(a|e|i|o|é|è|y)](\w*)$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ũ')"/>un<xsl:value-of select="substring-after(.,'ũ')"/></reg></choice>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũ$')">
                <choice><orig><xsl:value-of select="."/></orig>
      <reg><xsl:value-of select="substring-before(.,'ũ')"/>un</reg></choice>
            </xsl:when>
...
<xsl:when test="matches(.,'^(\w*)cõmãderẽt$')">
       <reg><xsl:value-of select="substring-before(.,'cõmãderẽt')"/>commanderent</reg>
           ...
           <!--nécessiterait 3 passages des règles sans cette exception-->
<xsl:when test="matches(.,'^(\w*)cõmẽcemẽt(\w*)$')">
       <reg><xsl:value-of select="substring-before(.,'cõmẽcemẽt')"/>commencement<xsl:value-of select="substring-after(.,'cõmẽcemẽt')"/></reg>
           </xsl:when>
           <!--nécessiterait 3 passages des règles sans cette exception-->
<xsl:when test="matches(.,'^(\w*)cõseruatiõ(\w*)$')">
       <reg><xsl:value-of select="substring-before(.,'cõseruatiõ')"/>conservation<xsl:value-of select="substring-after(.,'cõseruatiõ')"/></reg>
           </xsl:when>            
           <!--nécessiterait 3 passages des règles sans cette exception-->
<xsl:when test="matches(.,'^(\w*)cõdãnerẽt(\w*)$')">
       <reg><xsl:value-of select="substring-before(.,'cõdãnerẽt')"/>condamnerent<xsl:value-of select="substring-after(.,'cõdãnerẽt')"/></reg>
           </xsl:when>           
<xsl:when test="matches(.,'^(\w*)ãm(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ãm')"/>amm<xsl:value-of select="substring-after(.,'ãm')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ãb(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ãb')"/>amb<xsl:value-of select="substring-after(.,'ãb')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ãp(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ãp')"/>amp<xsl:value-of select="substring-after(.,'ãp')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)dãn(\w*)$', 'i')">
      <reg><xsl:value-of select="substring-before(.,'ãn')"/>amn<xsl:value-of select="substring-after(.,'ãn')"/></reg>     
            </xsl:when>   
<xsl:when test="matches(.,'^(\w*)ãn(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ãn')"/>ann<xsl:value-of select="substring-after(.,'ãn')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ã[^(a|e|i|o|u|é|è)](\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ã')"/>an<xsl:value-of select="substring-after(.,'ã')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ã$')">
      <reg><xsl:value-of select="substring-before(.,'ã')"/>an</reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽm(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ẽm')"/>emm<xsl:value-of select="substring-after(.,'ẽm')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽb(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ẽb')"/>emb<xsl:value-of select="substring-after(.,'ẽb')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽp(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ẽp')"/>emp<xsl:value-of select="substring-after(.,'ẽp')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽn(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ẽn')"/>enn<xsl:value-of select="substring-after(.,'ẽn')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽ[^(a|e|i|o|é|è)](\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ẽ')"/>en<xsl:value-of select="substring-after(.,'ẽ')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ẽ$')">
      <reg><xsl:value-of select="substring-before(.,'ẽ')"/>en</reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩm(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ĩm')"/>imm<xsl:value-of select="substring-after(.,'ĩm')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩb(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ĩb')"/>imb<xsl:value-of select="substring-after(.,'ĩb')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩp(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ĩp')"/>imp<xsl:value-of select="substring-after(.,'ĩp')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩn(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ĩn')"/>inn<xsl:value-of select="substring-after(.,'ĩn')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩ[^(a|e|i|o|u|é|è)](\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ĩ')"/>in<xsl:value-of select="substring-after(.,'ĩ')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ĩ$')">
      <reg><xsl:value-of select="substring-before(.,'ĩ')"/>in</reg>
            </xsl:when>             
<xsl:when test="matches(.,'^(\w*)õm(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'õm')"/>omm<xsl:value-of select="substring-after(.,'õm')"/></reg>
            </xsl:when>    
<xsl:when test="matches(.,'^(\w*)õb(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'õb')"/>omb<xsl:value-of select="substring-after(.,'õb')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)õp(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'õp')"/>omp<xsl:value-of select="substring-after(.,'õp')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)õn(\w*)$')">
   <reg><xsl:value-of select="substring-before(.,'õn')"/>onn<xsl:value-of select="substring-after(.,'õn')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)õ[^(é|è)](\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'õ')"/>on<xsl:value-of select="substring-after(.,'õ')"/></reg>
            </xsl:when> 
<xsl:when test="matches(.,'^(\w*)õ$')">
      <reg><xsl:value-of select="substring-before(.,'õ')"/>on</reg>
            </xsl:when>                  
<xsl:when test="matches(.,'^(\w*)ũm(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ũm')"/>umm<xsl:value-of select="substring-after(.,'ũm')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũb(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ũb')"/>umb<xsl:value-of select="substring-after(.,'ũb')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũp(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ũp')"/>ump<xsl:value-of select="substring-after(.,'ũp')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũn(\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ũn')"/>umn<xsl:value-of select="substring-after(.,'ũn')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũ[^(a|e|i|o|é|è)](\w*)$')">
      <reg><xsl:value-of select="substring-before(.,'ũ')"/>un<xsl:value-of select="substring-after(.,'ũ')"/></reg>
            </xsl:when>
<xsl:when test="matches(.,'^(\w*)ũ$')">
